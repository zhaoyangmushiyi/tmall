		...
		<div class="panel-body">
			<form method="post" id="editForm" action="admin_product_update">
				<table class="editTable">
					...
					<tr>
						<td>原价格</td>
						<td><input id="orignalPrice" name="orignalPrice" type="text" value="${product.orignalPrice}" class="form-control"></td>
					</tr>
					<tr>
						<td>优惠价格</td>
						<td><input id="promotePrice" name="promotePrice" type="text" value="${product.promotePrice}" class="form-control"></td>
					</tr>
					<tr>
						<td>库存</td>
						<td><input id="stock" name="stock" type="text" value="${product.stock}" class="form-control"></td>
					</tr>
					<tr class="submitTR">
